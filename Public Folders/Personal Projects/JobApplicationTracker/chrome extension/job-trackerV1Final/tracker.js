    ...
    <tr class="notes-row" id="notes-row-${app.id}" style="display:none;background:#f9fafb;">
      <td colspan="10" style="padding:12px 16px;color:#374151;font-size:14px;">
        <div style="display:flex;gap:32px;align-items:flex-start;">
          <div style="flex:1;min-width:0;max-width:100%;overflow:auto;">
            ...
            <textarea class="notes-edit" data-id="${app.id}" style="display:none;width:100%;max-width:100%;box-sizing:border-box;max-height:180px;min-height:100px;font-size:13px;padding:8px;border-radius:6px;border:1px solid #d1d5db;resize:vertical;margin-top:8px;">${app.notes || ''}</textarea>
